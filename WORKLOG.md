...
## 2026-01-10
- [x] Added CI workflow and updated contributor docs; CI runs gofmt/go vet/go test/go test -race on all branches.
- [x] Added CI policy notes to README.md and README.ja.md.
- [x] Moved discussion items from IMPROVEMENTS.md to this log.
